            ...
            <div v-if="projectDetails.proMainData.currentState > 4">
              ...
              <div class="meeting">
                <el-form ref="form" :model="proInfo" :rules="reviewRule" label-width="150px">
                  <el-form-item label="审批金额" prop="reviewAmount">
                    <el-input
...
import { getProDetail, approvalSubmit, editProject, getHistoryProDetail, getPreview } from '@/api/project/onlineview'
...
export default {
  ...
  methods: {
    ...
    preView(file) {
      ...
      // downReviewFile('/project/file/preview?mainid=' + file.mainId + '&fileid=' + file.gid, fileName)
    },
